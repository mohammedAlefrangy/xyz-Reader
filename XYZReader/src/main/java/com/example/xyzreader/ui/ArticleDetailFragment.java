...
//        ViewCompat.setTransitionName(mRootView.findViewById(R.id.app_bar_layout), EXTRA_IMAGE);
...
//        TextView article_title = mRootView.findViewById(R.id.article_title);
//        String title = article_title.getText().toString();
//        collapsingToolbarLayout.setTitle("mohammed");
